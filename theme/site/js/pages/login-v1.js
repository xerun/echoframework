...
$(function() {
        ...
        submitHandler: function (form) {
            ...
            $(form).ajaxSubmit({
                ...
                success: function(data){
                    l.stop();
                    //$("#basic-preview").slideDown('slow');
                    //$('.loader-overlay').addClass('loaded');
                    //$("#basic-preview p").html(data.message);
    ...
    //if ($('body').data('page') == 'login') {
        ...
        */
        $.backstretch(["theme/site/images/gallery/login4.jpg", "theme/site/images/gallery/login3.jpg", "theme/site/images/gallery/login2.jpg", "theme/site/images/gallery/login.jpg"], {
            fade: 600,
            duration: 4000
        });
        ...
        $('#image-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["theme/site/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
