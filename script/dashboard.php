<?php
    $BeforeEcho.='
      <link href="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/metrojs/metrojs.min.css" rel="stylesheet">
      <link href="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/maps-amcharts/ammap/ammap.min.css" rel="stylesheet">
    ';
    $Echo.='
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 portlets">
              ...
              <div class="panel widget-member clearfix">
                <div class="col-xs-3">
                  <img src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/images/avatars/user2.png" alt="avatar 12" class="pull-left img-responsive">
                </div>
                <div class="col-xs-9">
    ...
    ';
    $AfterEcho.='
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/noty/jquery.noty.packaged.min.js"></script>  <!-- Notifications -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/bootstrap-editable/js/bootstrap-editable.min.js"></script> <!-- Inline Edition X-editable -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/bootstrap-context-menu/bootstrap-contextmenu.min.js"></script> <!-- Context Menu -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/multidatepicker/multidatespicker.min.js"></script> <!-- Multi dates Picker -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/js/widgets/todo_list.js"></script>
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/metrojs/metrojs.min.js"></script> <!-- Flipping Panel -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/charts-chartjs/Chart.min.js"></script>  <!-- ChartJS Chart -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/charts-highstock/js/highstock.min.js"></script> <!-- financial Charts -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/charts-highstock/js/modules/exporting.min.js"></script> <!-- Financial Charts Export Tool -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/maps-amcharts/ammap/ammap.min.js"></script> <!-- Vector Map -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/maps-amcharts/ammap/maps/js/worldLow.min.js"></script> <!-- Vector World Map  -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/maps-amcharts/ammap/themes/black.min.js"></script> <!-- Vector Map Black Theme -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/skycons/skycons.min.js"></script> <!-- Animated Weather Icons -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/plugins/simple-weather/jquery.simpleWeather.js"></script> <!-- Weather Plugin -->
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/js/widgets/widget_weather.js"></script>
    <script src="'.$Application["BaseURL"].'/theme/'.$_REQUEST["Theme"].'/js/pages/dashboard.js"></script>
    ';